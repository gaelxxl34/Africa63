<footer class="bg-zinc-50 text-center text-surface/75 dark:bg-black text-white lg:text-left">
  ...
  <!-- Main container div: holds the entire content of the footer, including three sections (Logo, Useful links, and Contact) -->
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-3">
      <!-- Logo section -->
        <div class="flex justify-center md:justify-start">
            <img src="/assets/img/africa63.png" alt="Logo" style="height: 100px; width: 180px;">
        </div>

      <!-- Useful links section -->
      <div>
        <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start">Liens Utiles</h6>
        <p class="mb-4">
          <a href="#!">Actualités</a>
        </p>
        <p class="mb-4">
          <a href="/contact#equipe">Equipe</a>
        </p>
        <p class="mb-4">
          <a href="#!">Commandes</a>
        </p>
      ...
      <div>
        ...
        <p class="mb-4 flex items-center justify-center md:justify-start">
          ...
          Kampala, Close Boston Primary School, UG 
        </p>
        <p class="mb-4 flex items-center justify-center md:justify-start">
          <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
  ...
  <!--Copyright section-->
  <div class="p-6 text-center" style="background-color: #aa7d24">
    <span>© 2024 Copyright:</span>
    <a class="font-semibold" href="/">Africa63</a>
  </div>
</footer>